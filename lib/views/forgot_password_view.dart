...
import 'package:secondnotes/utilities/dialogs/password_reset_email_sent.dart';
          ...
          if (state.exception != null) {
            if (context.mounted) {
              await showErrorDialog(
                context,
                'We could not process your request plese make sure you are a registered user or go back one step to register',
              );
            }
          }
        }
      ...
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: Column(
            children: [
              const Text(
                'If you forgot your password plese enter your email so you could get sent a password reset link',
              ),
              TextField(
